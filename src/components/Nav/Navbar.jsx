...
import Logo from "../../images/logo/gym-logo(2).png";
import NavList from "../Nav/NavList";
import { Link } from "react-router-dom";
import LogoSide from "../../images/logo/gym-logo(2).png";
...
function Navbar() {
  ...
  return (
    <>
      <nav
        className={`flex bg-transparent items-center justify-between py-8 px-12  fixed top-0 left-0 right-0 w-full z-50 ${
          sticky ? "shadow-xl !bg-black" : ""
        }`}
      >
        <Link to="/">
          <img src={Logo} alt="logo_img" onClick={goTop} className="gymLogo" />
        </Link>
