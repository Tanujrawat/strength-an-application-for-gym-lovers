        ...
        <div className="page-padding py-[10rem] flex justify-center">
          ...
          >
            ...
            <input
              ...
              placeholder="Strength@gymail.com"
              type="email"
            ...
            <div className="flex gap-4 items-center mt-16 min450:flex-col">
              <p className="text-white text-[1.5rem]">New to <span className="strength">Strength</span> ?</p>
              <Link
                to="/signup"
            ...
            <p className="text-[#ffffffbc] text-[1.4rem] mt-3">
              ...
              strength@gymail.com <span className="text-[#ff0336]"> / </span>
              testpassword123
            </p>
          </form>
        </div>
